...
document.querySelector("#dog-picture").addEventListener("click"),
    () => alert(`i was clicked :)`);
...
document.querySelector("#class-schedule-list").addEventListener("mouseover"),
...
document.querySelector("body").addEventListener("keypress", (event) => console.log("The " + event.key + was pressed!");